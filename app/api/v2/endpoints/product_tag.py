...
# GET: Fetch with id
@router.get("/{product_id}/{tag_id}", response_model=ProductTagOut)
...
# POST: Create new row
@router.post("/", response_model=ProductTagOut, status_code=status.HTTP_201_CREATED)
...
# PUT: Update row
@router.put("/{product_id}/{tag_id}", response_model=ProductTagOut)
...
# DELETE: Delete row
@router.delete("/{product_id}/{tag_id}", response_model=ProductTagOut)
